...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzU5ZjA3NjY1NDBjMTAwM2QxMTVkMjciLCJpYXQiOjE3Mzk5MDQyNjMsImV4cCI6MTc0MDUwOTA2M30.gs4pQpw1gCDNJCljWnwpu3LNdZEbic0fHRc3QyNh-QY";
    ...
    public void addNewPhoto() {
        given()
                ...
                .then().statusCode(202); // Проверяем код ответа
    }
